...
namespace ThanhTuan.Blogs.Interfaces
{
  public interface ICommentRepository
  {
    ...
    Task<List<PostComment>> GetPostComments(int postId, ListParameter<PostComment> param);
    Task<List<PostComment>> GetSubPostComments(int commentId, ListParameter<PostComment> param);
